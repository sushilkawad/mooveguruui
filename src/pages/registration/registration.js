...
<p className="larger sub">
  Over 4 lakh investors use Screener for finding and tracking stock ideas.</p>
...
<div className="card card-small text-align-center" style={{margin: 0}}>
  <a href="/login/google/" className="flex flex-gap-16 flex-align-center" style={{justifyContent: 'center'}}>
    ...
    <span className="upper ink-900 letter-spacing strong" style={{fontSize: "1.5rem"}}>Register using Google</span>
  </a>
</div>
...
<form method="post" action="/login/" className="card card-medium">
  <input type="hidden" name="csrfmiddlewaretoken" value="bf6jVkz79vTGwWvMi3kdQxJ1KGffsnuW3AsYQWcbMO3BtxjLEqHPHKYJnf8FAsV5" />
...
<p className="larger" style={{margin: "1.7rem 0 1rem"}}>
</p>
