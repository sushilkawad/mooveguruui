...
<p className="larger sub">Login to your account using your email and password.</p>
...
<div className="card card-small text-align-center" style={{margin: 0}}>
  <a href="/login/google/" className="flex flex-gap-16 flex-align-center" style={{justifyContent: 'center'}}>
    ...
    <span className="upper ink-900 letter-spacing strong" style={{fontSize: "1.5rem"}}>Login using Google</span>
  </a>
</div>
